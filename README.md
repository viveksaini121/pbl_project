...
## Add SHAP explainability (beginner-friendly)

After training, SHAP tells you **which input features influenced predictions the most**.
...
- Model metrics in terminal:
  - Accuracy
  - Precision
  - Recall
  - F1 Score
- A graph file with top 10 most important features:
  - `data/processed/shap_top10_features.png`

### Very simple explanation

- The script trains Random Forest on `train.csv`.
- It predicts labels on `test.csv`.
- SHAP computes contribution of each feature.
- We take average absolute SHAP value (bigger = more important).
- We plot top 10 features in a horizontal bar chart and save it.
